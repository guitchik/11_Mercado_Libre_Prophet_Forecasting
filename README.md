# 11_Mercado_Libre_Prophet_Forecasting


## Background

In this scenario, a growth analyst at [Mercado Libre](http://investor.mercadolibre.com/investor-relations). With over 200 million users, Mercado Libre is the most popular e-commerce site in Latin America. You've been tasked with analyzing the company's financial and user data in clever ways to help the company grow. 

In a bid to drive revenue, this Jupyter notebook contains a data preparation, analysis, and visualizations for all the time series data that the company needs to understand. You’ll use text and comments to document your findings. This notebook contains the following:
...
This project helps to gain proficiency in the following tasks:
